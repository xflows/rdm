...
if __name__ == "__main__":
    ...
    parser.add_argument('--target_table',type=str,default="paper")
    parser.add_argument('--target_label',type=str,default="class_label")
    ...
    #connection2 = SQLparser(
    #    '../../datasets/sql/cacn.sql'
    #)
