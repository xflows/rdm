...
def connection_setting(dataset):
...
if __name__ == "__main__":
    ...
    connection = connection_setting(args.dataset)

    ## NIKA: a se da tale connection imeti pri sebi v ramu?
